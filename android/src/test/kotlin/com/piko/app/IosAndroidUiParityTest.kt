...
class IosAndroidUiParityTest {
    ...
    fun iosReceiveRootUsesPageBackgroundThroughSystemBars() {
        ...
        assertTrue("static let emptyStateEstimatedHeight: CGFloat = 300" in iosReceive)
        assertTrue("return NativeReceiveLayout.emptyStateEstimatedHeight" in iosReceive)
