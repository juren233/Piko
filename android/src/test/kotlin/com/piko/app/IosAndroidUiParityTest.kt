...
class IosAndroidUiParityTest {
    ...
    fun receiveHistoryDeletionUsesSwipeConfirmationAndSavedFileReferencesOnBothPlatforms() {
        ...
        assertTrue("val revealedWidth" in androidReceive)
        assertTrue(".width(revealedWidth)" in androidReceive)
        ...
        assertTrue("Dialog(onDismissRequest = onDismiss)" in androidReceive)
        ...
        assertTrue("DragGesture(minimumDistance: 10)" in iosReceive)
        assertTrue("private let deleteWidth: CGFloat = 96" in iosReceive)
