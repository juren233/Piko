...
class IosAndroidUiParityTest {
    ...
    fun p2pInFlightWindowIsAlignedOnAndroidAndIos() {
        ...
        assertTrue("currentInFlightWindow = min(self.maxInFlightChunks, currentInFlightWindow + 1)" in iosClient)
        assertFalse("currentInFlightWindow = min(maxInFlightChunks, currentInFlightWindow + 1)" in iosClient)
