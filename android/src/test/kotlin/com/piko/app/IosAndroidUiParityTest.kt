...
class IosAndroidUiParityTest {
    ...
    fun receiveHistoryDeletionUsesSwipeConfirmationAndSavedFileReferencesOnBothPlatforms() {
        ...
        assertTrue("rowView(bottom: bottomSpacing)" in iosReceive)
        assertFalse("nextRows.append(.gap(" in iosReceive)
        assertFalse("case gap(" in iosReceive)
        assertFalse("forCellReuseIdentifier: \"gap\"" in iosReceive)
        ...
        assertTrue("private func reloadIndexPathsForAnimatedDeletion(" in iosReceive)
